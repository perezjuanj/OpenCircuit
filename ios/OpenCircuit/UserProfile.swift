    ...
    var body: some View {
        Form {
            ...
            Section("Daily goals") {
                ...
                Text("Progress rings on the dashboard show today's goal vs. actual. Elevated-HR minutes are an estimate, not detected workout duration: they count time at least 40% of the way from your own resting heart rate up to your age-estimated maximum, so a naturally fast or slow resting pulse doesn't shift the ring. Active calories use those same qualifying periods with steps as the fallback.")
                    .font(.caption).foregroundStyle(.secondary)
            }
