// Bulk PPG / optical-trend SAMPLE decode (docs/PROTOCOL.md §5.2, issue #8).
//
...
// actual sample values. Settled offline (issue #8, `desktop/analyze_0x47_bitwidth.py` /
...
//
// Still open (needs the app's own exported PPG trace to close #8): channel IDENTITY
